...
python main.py -data SLEEP -m harcnnbn -algo FedKD -gr 500 -did 0 -nc 15 -lbs 32 -nb 12 -jr 0.4 -ls 4 -ld True -dev cuda -lr 0.01 -mlr 0.01 -Ts 0.9 -wb true

python main.py -data SLEEP -m harcnnbn -algo FedFomo -gr 500 -did 0 -nc 15 -lbs 32 -nb 12 -jr 0.4 -ls 4 -ld True -dev cuda -wb true

python main.py -data SLEEP -m harcnnbn -algo MOON -gr 500 -did 0 -nc 15 -lbs 32 -nb 12 -jr 0.4 -ls 4 -ld True -dev cuda -wb true

python main.py -data SLEEP -m harcnnbn -algo FedDistill -gr 500 -did 0 -nc 15 -lbs 32 -nb 12 -jr 0.4 -ls 4 -ld True -dev cuda -wb true 
