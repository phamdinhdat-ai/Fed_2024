...
# # test on HAR dataset
python main.py -data HAR -m harcnnbn -algo FedKDX -gr 500 -did 0 -nc 30 -lbs 64 -nb 6 -jr 0.4 -ls 4 -ld True -dev cuda  -lr 0.01 -mlr 0.01 -Ts 0.9
...
python main.py -data HAR -m harcnn -algo FedKD -gr 500 -did 0 -nc 30 -lbs 64 -nb 6 -jr 0.4 -ls 5 -ld True -dev cuda 

python main.py -data HAR -m harcnn -algo FedFomo -gr 500 -did 0 -nc 30 -lbs 64 -nb 6 -jr 0.4 -ls 4 -ld True -dev cuda


python main.py -data HAR -m harcnn -algo MOON -gr 500 -did 0 -nc 30 -lbs 64 -nb 6 -jr 0.4 -ls 4 -ld True -dev cuda


python main.py -data HAR -m harcnn -algo FedDistill -gr 500 -did 0 -nc 30 -lbs 64 -nb 6 -jr 0.4 -ls 4 -ld True -dev cuda

python main.py -data HAR -m harcnn -algo FedMTL -gr 500 -did 0 -nc 30 -lbs 64 -nb 6 -jr 0.4 -ls 4 -ld True -dev cuda
